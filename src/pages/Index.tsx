...
function ModelSelector({ selectedModel, onSelectModel }: { selectedModel: ModelId; onSelectModel: (m: ModelId) => void }) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute bottom-full left-0 mb-1 bg-popover border border-border/40 rounded-2xl shadow-lg z-[100] min-w-[200px] max-h-[400px] overflow-y-auto py-1.5" style={{ transformOrigin: 'bottom left' }}>
          {MODELS.map((m) => (
            <button
              key={m.id}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className={cn("h-12 shrink-0 flex items-center justify-between px-3 sm:px-4 glass-subtle border-b border-border/20", isElectron && "pl-[76px]")}>
          <div className="flex items-center gap-2">
            ...
            {/* Model selector moved above input bar */}
            {ghostMode && (
        ...
        {ToolUIComponent ? (
          ...
          <>
            ...
            <div className="flex items-center px-3 sm:px-4 pb-1">
