          ...
          {!collapsed ? (
            <div className="px-2 pt-1">
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-[14px] text-sidebar-foreground/70 hover:bg-sidebar-accent/70 hover:text-sidebar-foreground transition-all duration-200 hover:translate-x-0.5 touch-manipulation text-left press-scale"
              >
                  ...
                  <div className="space-y-0.5 pb-1">
                    {SKILLS.map((skill) => (
                      ...
                      >
                        ...
                        {skill.badge && (
                          <span className="text-[9px] font-medium px-1.5 py-0.5 rounded bg-primary/15 text-primary">{skill.badge}</span>
                        )}
                      </button>
                    ))}
                  </div>
